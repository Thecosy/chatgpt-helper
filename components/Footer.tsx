  ...
  return (
    <footer className="text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3">
      ...
      <div className="flex space-x-4 pb-4 sm:pb-0">
        ...
        <Link aria-hidden="true" href="https://t.me/+3MgX0yHFR2s5OWQ1" className="group w-36" >
          <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g>
